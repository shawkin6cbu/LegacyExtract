...
QCheckBox {
    ...
    color: #e8eaed;
    padding: 4px 0;
    /* border-color: #5f6368; Removed as border is on indicator */
}
QCheckBox::indicator {
    width: 12px;  /* Same as QRadioButton::indicator width */
    height: 12px; /* Same as QRadioButton::indicator height */
    border: 2px solid #5f6368; /* MATCHES QRadioButton border: 2px solid #5f6368 */
    border-radius: 3px;        /* Square-ish, or 0px for perfect square */
    background-color: #3c4043; /* Background when unchecked */
}
QCheckBox::indicator:hover {
    border-color: #a1c9fa; /* Lighter blue for hover on border (MATCHES QRadioButton hover) */
}
QCheckBox::indicator:checked {
    background-color: #8ab4f8; 
    border-color: #5f6368;    /* Keep border consistent when checked */
   
}
QCheckBox::indicator:checked:hover {
    background-color: #a1c9fa; /* Or #a1c9fa if :checked background is #8ab4f8 */
    border-color: #a1c9fa;    /* Keep border consistent on hover, matching radio button checked hover */
    
}
QCheckBox::indicator:disabled {
    border-color: #3c4043;     /* MATCHES QRadioButton disabled border */
    background-color: #2a2b2d; /* MATCHES QRadioButton disabled background */
    image: none;
}
QCheckBox::indicator:disabled:checked {
    background-color: #2a2b2d; /* Keep background same as disabled unchecked */
    border-color: #3c4043;     /* Keep border consistent */
