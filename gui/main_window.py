...
class ContractProcessorApp(QMainWindow):
    ...
    def _update_output_directory_for_contract_type(self, contract_type_text):
        if contract_type_text == "Legacy":
            self.output_dir_edit.setText("T:\Closings\Legacy SELLER")
        else:
            self.output_dir_edit.setText("T:\Closings")
...
# --- main.py (Example of how this might be run) ---
# if __name__ == '__main__':
#     import sys
#     from gui.styles import modern_stylesheet # Assuming you have this

#     app = QApplication(sys.argv)
#     app.setStyle("Fusion") # Recommended for consistent QSS behavior
#     app.setStyleSheet(modern_stylesheet) # Apply your global stylesheet
